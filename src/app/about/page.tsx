...
export default function AboutPage(){return <><InnerHeader current="about"/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(person).replace(/</g,"\\u003c")}}/><main className="about-main">
 ...
 <section className="about-section"><p className="section-label">Qualifications</p><div><h2>Technical range. Direct accountability.</h2><p>I work across IT, software, and applied AI: diagnosing a system, planning the repair, implementing it, testing the important paths, and handing it over with documentation. The work can be a focused technical engagement, a contract role, or a complete NextEleven build.</p></div></section>
 ...
 <section className="about-section"><p className="section-label">Location and work</p><div><h2>DFW base. Available for roles and contract work.</h2><p>I’m a U.S. citizen and do not require sponsorship. I’m available for employment, contract engagements, consulting, technical support, implementation, software development, IT work, and applied-AI projects at the scope the operation requires.</p></div></section>
