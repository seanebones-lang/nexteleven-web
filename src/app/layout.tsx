...
export const metadata: Metadata = { metadataBase: new URL("https://www.nexteleven.dev"), title: { default: "NextEleven — Sean McDonnell", template: "%s — NextEleven" }, description: "Sean McDonnell builds backend systems, applied AI, retrieval, developer tools, and operational software from Mansfield, Texas." };
